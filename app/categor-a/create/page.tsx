...
export default function FormPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <PageHeader title="Nuevo Categor a" subtitle="Completa los datos y guarda." />
      <Card>
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); router.push("/categor-a"); }}>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="button" variant="secondary" onClick={() => router.push("/categor-a")}>Cancelar</Button>
          </div>
        </form>
      </Card>
    </div>
