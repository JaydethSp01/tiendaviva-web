...
export default function FormPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <PageHeader title="Nuevo Pedido" subtitle="Completa los datos y guarda." />
      <Card>
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); router.push("/pedido"); }}>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="button" variant="secondary" onClick={() => router.push("/pedido")}>Cancelar</Button>
          </div>
        </form>
      </Card>
    </div>
